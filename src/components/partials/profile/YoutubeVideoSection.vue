	...
	<div>
		<div class="mx-auto py-4">
			<div class="flex flex-wrap font-bold text-gray-100">
				...
				<div class="w-full mt-4">
					<RouterLinkButton class="ml-2 hover:bg-red-500 border-red-500" btnText="Delete Youtube Video"
						color="green" url="/account/delete-youtube-video" />
		...
		<div class="flex flex-wrap mb-4">
			<div class="my-1 px-1 w-full md:w-1/2 lg:w-1/2">
				...
				<iframe class="w-full h-60" src="https://www.youtube.com/embed/eud1fjcgStQ?autoplay=0"></iframe>
			</div>
		</div>
	</div>
</template>
