		...
		<div class="bg-white rounded px-8 pt-6 pb-8">
			<div class="flex flex-wrap">
				<div class="w-1/4 mr-auto mt-2 text-lg p-1 text-gray-900">
					1. Youtube Video 1
					<iframe class="w-full h-20" src="https://www.youtube.com/embed/eud1fjcgStQ?autoplay=0"></iframe>
				</div>

				<div class="w-1/4 ml-auto p-1">
					<button class="float-right bg-transparent hover:bg-red-500 text-gray-900 font-semibold hover:text-white py-2 px-4 border border-red-400 hover:border-transparent rounded">
						Delete
					</button>
				</div>
